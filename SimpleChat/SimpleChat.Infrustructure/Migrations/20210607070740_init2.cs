        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatType = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InitiatorUserId = table.Column<string>(type: "varchar(15)", nullable: false),
                    ReceiverUserId = table.Column<string>(type: "varchar(15)", nullable: false),
                    FriendshipStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friendships", x => new { x.InitiatorUserId, x.ReceiverUserId });
                    table.ForeignKey(
                        name: "FK_Friendships_Users_InitiatorUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderId = table.Column<string>(type: "varchar(15)", unicode: false, nullable: false),
                    ChatId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_InitiatorUserId",
                table: "Friendships",
